...
class SAR_Project:
    ...
    def index_dir(self, root, **args):
        ...
        self.speller = spellsuggester.SpellSuggester(opcionesSpell, vocab=list(self.index.keys()), default_distance=self.distance, default_threshold=self.threshold)
    ...
    def index_file(self, filename):
        ...
        input: "filename" es el nombre de un fichero en formato JSON Arrays (https://www.w3schools.com/js/js_json_arrays.asp).
                Una vez parseado con json.load tendremos una lista de diccionarios, cada diciocnario se corresponde a una noticia
    ...
    def get_posting(self, term):
        ...
        if not r1 and self.use_spelling:
            ...
            for term in speller_resul:
                r1 = self.or_posting(r1, self.index[term])
